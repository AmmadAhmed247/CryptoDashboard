                ...
                <tr key={idx} className="border-zinc-700 hover:bg-zinc-700/50 border-b transition-all cursor-pointer group">
                  ...
                  <td className="py-4 px-4 flex justify-center">
                    <button
                      ...
                      className="p-2 bg-[#d0b345] rounded-lg text-right text-xs font-semibold text-white transition-all shadow-lg hover:shadow-xl hover:scale-110 flex items-center ">
                      <Plus size={16} />
                    </button>
                  </td>
                </tr>
