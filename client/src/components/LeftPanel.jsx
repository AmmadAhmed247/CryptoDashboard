        ...
        >
          ...
          {bitcoinHalving ? (
            <div className="space-y-2">
              ...
              {/* Blocks Remaining */}
              <div
                className={`flex justify-between items-center text-xs ${isDarkMode ? 'text-zinc-300' : 'text-gray-700'
                  }`}
              >
                <span
              ...
              {/* Progress Bar */}
              <div
                className={`w-full ${isDarkMode ? 'bg-zinc-700' : 'bg-gray-200'
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <span
                    className={`text-xs font-semibold ${changeValue > 0
                        ? 'text-green-400'
                        : changeValue < 0
                          ? 'text-red-400'
                          : isDarkMode
