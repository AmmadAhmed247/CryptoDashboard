        ...
        {isLoading ? (
          ...
          >
            <div className="flex items-center gap-2 mb-3">
              <Zap
                className={`${
                  altSeasonIndex >= 75 ? 'text-green-500' : 'text-red-600'
                }`}
                size={18}
              />
              <h3
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                >
                  Alt season starts at 75+
                </div>
              </div>

              {/* ✅ Circle Gauge with Sticker */}
              <div className="relative w-20 h-20 flex items-center justify-center">
                <svg className="w-full h-full -rotate-90" viewBox="0 0 36 36">
                  {/* Background Circle */}
                  <circle
                    className={`stroke-[3] ${
                      isDarkMode ? 'stroke-zinc-700' : 'stroke-gray-300'
                    }`}
                    fill="none"
                    cx="18"
                    cy="18"
                  ...
                  <circle
                    className={`stroke-[3] ${
                      altSeasonIndex >= 75 ? 'stroke-green-500' : 'stroke-red-600'
          ...
          >
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <span className="text-2xl font-bold text-[#d0b345]">
              ...
              >
                <div
                  ...
                  style={{
                    width: `${100 - (
                      (bitcoinHalving.blocksRemaining / 210000) *
                      100
                    ).toFixed(2)}%`,
                  }}
                ></div>
